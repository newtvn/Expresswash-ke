      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="max-w-xl mx-auto mb-12">
          <div className="flex gap-3">
            <Input
              ...
              className="h-12 text-base rounded-xl border-slate-200 focus:border-brand-blue focus:ring-brand-blue/20"
        ...
        {order && (
          <div className="max-w-4xl mx-auto animate-fade-in">
            {/* Current Status Card */}
            <div className={`relative rounded-2xl p-8 mb-8 overflow-hidden text-white ${orderIsCancelled ? 'bg-gray-700' : 'bg-brand-blue'}`}>
              {/* Decorative bubbles */}
        ...
        {!order && !error && (
          <div className="text-center py-16">
            <div className="w-20 h-20 rounded-full bg-brand-blue/10 mx-auto mb-6 flex items-center justify-center">
