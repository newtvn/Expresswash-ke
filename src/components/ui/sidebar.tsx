    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="w-[min(var(--sidebar-width),88vw)] bg-sidebar/95 backdrop-blur-xl p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
