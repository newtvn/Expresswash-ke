...
const AccountsSalesCharts = lazy(() =>
  import('./AccountsSalesCharts').then((m) => ({ default: m.AccountsSalesCharts }))
);
    ...
    <div className="mt-4 space-y-6">
      ...
      {showOperationalSales && (
        <Suspense fallback={<Skeleton className="h-[200px] w-full" />}>
          <AccountsSalesCharts orders={orders} salesByPersonData={salesByPersonData} salesByItem={salesByItem} />
        </Suspense>
      )}
    </div>
  );
